  ...
  const handleCreateLovableBackup = async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('cities').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('hotels').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('hotel_owners').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('hotel_responsible_persons').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('hotel_seasonal_pricing').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('profiles').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('user_roles').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('user_guests').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('bookings').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('booking_actions_log').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('room_availability').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('reviews').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('complaints').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('coupons').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('coupon_hotels').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('api_settings').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('api_requests').select('*').then(res => res.error ? { data: [] } : res),
        supabase.from('whatsapp_settings').select('*').maybeSingle().then(res => res.error ? { data: null } : res),
        supabase.from('pdf_settings').select('*').maybeSingle().then(res => res.error ? { data: null } : res),
        supabase.from('site_settings').select('*').order('created_at', { ascending: false }).limit(1).maybeSingle().then(res => res.error ? { data: null } : res),
      ]);
